...
BettingSiteMappings.Insert({"OMName": "BETSAFE", "UMNames": ["betsafe"]})
BettingSiteMappings.Insert({"OMName": "WILLIAM HILL", "UMNames": "William Hill"})
BettingSiteMappings.Insert({"OMName": "PADDY POWER", "UMNames": "_M Paddy Power"})
